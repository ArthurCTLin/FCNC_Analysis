{
    TFile *fin1 = new TFile("./sample/2017_Zut//hist_w_mt_emm.root");
    TFile *fin2 = new TFile("./sample/2017_Zut//hist_b_no_emm.root");
    ...
    TFile *fin4 = new TFile("./sample/2017_Zut//hist_Zmass_emm.root");
    TH1D *TTCR_sig = (TH1D*)fin3->Get("ttbar");
    TH1D *TTCR_sig_emm = (TH1D*)fin4->Get("ttbar");
    TH1D *TTCR_data = (TH1D*)fin3->Get("data");

    TFile *fin5 = new TFile("./sample/2017_Zut//hist_mva_emm.root");
    //
...
//{{{TTCR
    ...
    double ttbar_No = (TTCR_N_sig.getVal()-sigregion_sig2->getVal()*TTCR_N_sig.getVal())*(TTCR_sig_emm->Integral()/TTCR_sig->Integral())*(Exp_SR/Exp_SB);
...
//}}}
    ...
    RooRealVar Final_N_bkg_ttbar("Final_N_bkg_ttbar", "Final_N_bkg_ttbar", Final_N_ttbar, -50, 200);
    RooRealVar Final_N_bkg_TTZ("Final_N_bkg_TTZ", "Final_N_bkg_TTZ", Final_N_TTZ, -50, 200);
    RooRealVar Final_N_bkg_WZ("Final_N_bkg_WZ", "Final_N_bkg_WZ", Final_N_WZ, -50, 200);
    RooRealVar Final_N_bkg_ZZ("Final_N_bkg_ZZ", "Final_N_bkg_ZZ", Final_N_ZZ, -50, 200);
    RooRealVar Final_N_bkg_tZq("Final_N_bkg_tZq", "Final_N_bkg_tZq", Final_N_tZq , -50, 200);
    RooRealVar Final_N_bkg_DY("Final_N_bkg_DY", "Final_N_bkg_DY", Final_N_DY, -50, 200);
    RooRealVar Final_N_bkg_other("Final_N_bkg_other", "Final_N_bkg_other", Final_N_other, -50, 200);
