{
    TFile *fin1 = new TFile("./sample/2016_Zut//hist_w_mt_eem.root");
    TFile *fin2 = new TFile("./sample/2016_Zut//hist_b_no_eem.root");
    ...
    TFile *fin4 = new TFile("./sample/2016_Zut//hist_Zmass_eem.root");
    TH1D *TTCR_sig = (TH1D*)fin3->Get("ttbar");
    TH1D *TTCR_sig_eem = (TH1D*)fin4->Get("ttbar");
    TH1D *TTCR_data = (TH1D*)fin3->Get("data");

    TFile *fin5 = new TFile("./sample/2016_Zut//hist_mva_eem.root");
    //
