{
    TFile *fin1 = new TFile("./sample/2017_Zut//hist_w_mt_eee.root");
    TFile *fin2 = new TFile("./sample/2017_Zut//hist_b_no_eee.root");
    ...
    TFile *fin3 = new TFile("./sample/2017_Zut//Zmass_combine.root");
    TFile *fin4 = new TFile("./sample/2017_Zut//hist_Zmass_eee.root");
    TH1D *TTCR_sig = (TH1D*)fin3->Get("ttbar");
    TH1D *TTCR_sig_eee = (TH1D*)fin4->Get("ttbar");
    TH1D *TTCR_data = (TH1D*)fin3->Get("data");

    TFile *fin5 = new TFile("./sample/2017_Zut//hist_mva_eee.root");
    //
...
//{{{ WZCR   
    ...
    pt->Draw();
*/
    //c1->SaveAs("./plot/WZCR_eee.png");
//}}}
    
//{{{TTCR
    RooRealVar TTCR_N_sig("TTCR_N_sig", "TTCR_N_sig", 10, -50, 5000);   
...
//}}}
    ...
    RooRealVar Final_N_sig("Final_N_sig", "Final_N_sig", 10, -150., 300);   
    ...
    RooArgSet Final_gausConstraint( Final_constraint_TTZ, Final_constraint_WZ, Final_constraint_ZZ, Final_constraint_tZq, Final_constraint_DY, Final_constraint_other);
    ...
    RooAddPdf Final_total_pdf("Final_total_pdf", "Final_total_pdf", RooArgList(Final_sig_pdf, Final_bkg_pdf_TTZ, Final_bkg_pdf_WZ, Final_bkg_pdf_ZZ, Final_bkg_pdf_tZq, Final_bkg_pdf_DY, Final_bkg_pdf_other), RooArgList(Final_N_sig, Final_N_bkg_TTZ, Final_N_bkg_WZ, Final_N_bkg_ZZ, Final_N_bkg_tZq, Final_N_bkg_DY, Final_N_bkg_other));
