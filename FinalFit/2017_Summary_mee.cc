{
    TFile *fin1 = new TFile("./sample/2017_Zut//hist_w_mt_eem.root");
    TFile *fin2 = new TFile("./sample/2017_Zut//hist_b_no_eem.root");
    ...
    TFile *fin4 = new TFile("./sample/2017_Zut//hist_Zmass_eem.root");
    TH1D *TTCR_sig = (TH1D*)fin3->Get("ttbar");
    TH1D *TTCR_sig_eem = (TH1D*)fin4->Get("ttbar");
    TH1D *TTCR_data = (TH1D*)fin3->Get("data");

    TFile *fin5 = new TFile("./sample/2017_Zut//hist_mva_eem.root");
    //
...
//{{{TTCR
    ...
    double ttbar_No = (TTCR_N_sig.getVal()-sigregion_sig2->getVal()*TTCR_N_sig.getVal())*(TTCR_sig_eem->Integral()/TTCR_sig->Integral())*(Exp_SR/Exp_SB);
