{    
  ...
  chain.Add("/wk_cms/arthur6745/Data/CRABdata/Data_File_2016/Double_ele_2016B/*");
  ...
  TFile *hfile = new TFile("./Result_run_fcnc_files_2016/data_double_e_RunB.root","RECREATE","Ttbar-fcnc-Signal");
