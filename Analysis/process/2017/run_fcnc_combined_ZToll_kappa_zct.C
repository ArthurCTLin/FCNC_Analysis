{    
  ...
  chain.Add("/wk_cms/arthur6745/Data/CRABdata/MCSample_File_2017/Tleptonic_kappa_zct/*");
  chain.Add("/wk_cms/arthur6745/Data/CRABdata/MCSample_File_2017/aTleptonic_kappa_zct/*");
  ...
  TFile *hfile = new TFile("./Result_run_fcnc_files_2017/sigTT_kappa_zct_combined.root", "RECREATE", "Ttbar-fcnc-Signal");
