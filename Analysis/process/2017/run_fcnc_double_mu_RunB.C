{    
  ...
  chain.Add("/wk_cms/arthur6745/Data/CRABdata/Data_File_2017/Double_mu_2017B/*");
  ...
  TFile *hfile = new TFile("./Result_run_fcnc_files_2017/data_double_mu_RunB.root","RECREATE","Ttbar-fcnc-Signal");
