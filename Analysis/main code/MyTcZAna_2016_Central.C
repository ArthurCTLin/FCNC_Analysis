...
/*   
   if(
      ...
      (int)EvtInfo_TrgBook[HLT_PFMET120_PFMHT120_IDTight_v9] != 1 &&
      (int)EvtInfo_TrgBook[HLT_PFMET120_PFMHT120_IDTight_v10] != 1 &&
      (int)EvtInfo_TrgBook[HLT_PFMET120_PFMHT120_IDTight_v11] != 1 &&
      (int)EvtInfo_TrgBook[HLT_PFMET120_PFMHT120_IDTight_v12] != 1 &&
      (int)EvtInfo_TrgBook[HLT_PFMET120_PFMHT120_IDTight_v13] != 1 &&
      (int)EvtInfo_TrgBook[HLT_PFMET120_PFMHT120_IDTight_v14] != 1 &&
      (int)EvtInfo_TrgBook[HLT_PFMET120_PFMHT120_IDTight_v15] != 1 &&
      (int)EvtInfo_TrgBook[HLT_PFMET120_PFMHT120_IDTight_v16] != 1 &&
      (int)EvtInfo_TrgBook[HLT_PFMET120_PFMHT120_IDTight_v17] != 1 &&
      (int)EvtInfo_TrgBook[HLT_PFMET120_PFMHT120_IDTight_v18] != 1 &&
      (int)EvtInfo_TrgBook[HLT_PFMET120_PFMHT120_IDTight_v19] != 1 &&
      (int)EvtInfo_TrgBook[HLT_PFMET120_PFMHT120_IDTight_v20] != 1 &&
      ...
      (int)EvtInfo_TrgBook[HLT_PFMET170_HBHECleaned_v9] != 1 ) return(kFALSE);
*/
    if(
      //di-Muon trigger
      (int)EvtInfo_TrgBook[HLT_Mu17_TrkIsoVVL_Mu8_TrkIsoVVL_DZ_v2] != 1 &&
...
void MyTcZAna_2016_Central::ReconBJet(){
  ...
  //b-tagging jets 
    //if(Jets_CombinedIncSVBJetTags[ij1] > JET_BTAG_CUT){
