#ifndef MyTcZAna_2017_Central_h
#define MyTcZAna_2017_Central_h
...
class MyTcZAna_2017_Central : public TSelector {
private :
...
//-----------------------------adding TMVA variables---------------------------------//
   ...
   //MyTcZAna_2017_Central(TTree * /*tree*/ =0) : fChain(0) { }
   MyTcZAna_2017_Central(TTree * /*tree*/ =0) { }
   virtual ~MyTcZAna_2017_Central() { }
   ...
   ClassDef(MyTcZAna_2017_Central,0);
};

#endif

#ifdef MyTcZAna_2017_Central_cxx
void MyTcZAna_2017_Central::Init(TTree *tree)
{
...
Bool_t MyTcZAna_2017_Central::Notify()
{
...
#endif // #ifdef MyTcZAna_2017_Central_cxx
