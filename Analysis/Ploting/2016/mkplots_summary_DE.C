...
#define TcZ 1055193 
#define TuZ 2088734 
#define ttjets 76915549
#define t_s  33033621.73 
#define t_t  66709844
#define t_tw  6949850
#define tb_t 38725265
#define tb_tw 6925836
#define DY10to50  2047277669462.09 
#define DY50    1850303944587.21 

#define ttwqq   569424.1463
#define ttwln   731276.4818
#define ttzqq   396340.938
#define ttzll   501396.8335
#define wz2l2q  231457273
#define wz3ln   97448992.28
#define tZq     1051451.044
#define zz2l2n  48630976
#define zz2l2q  496436
#define zz4l    96266822
#define ww2l2n  1999000
#define tthTobb 2178948.561
#define tthToNonbb 2236349.018

#define INT_LUM  35921.90891 //36773.0
...
std::string histFiles[nFiles]=
  {
    "../Result_run_fcnc_files_total/2016/Zct/Central/sigTT_kappa_zct_combined.root",  //TTbar to bW & cZ kappa_zct (combined top and anti-quark)
    
    "../Result_run_fcnc_files_total/2016/Zct/Central/bkg_TTJets_powheg.root",        //ttjets
    "../Result_run_fcnc_files_total/2016/Zct/Central/bkg_ttHTobb.root",         //tthiggs
    "../Result_run_fcnc_files_total/2016/Zct/Central/bkg_ttHToNonbb.root",         //tthiggs
    "../Result_run_fcnc_files_total/2016/Zct/Central/bkg_TTWqq.root",      //ttwqq                                                      
    "../Result_run_fcnc_files_total/2016/Zct/Central/bkg_TTWln.root",      //ttwln
    "../Result_run_fcnc_files_total/2016/Zct/Central/bkg_TTZqq.root",      //ttzqq
    "../Result_run_fcnc_files_total/2016/Zct/Central/bkg_TTZll.root",      //ttzll
    "../Result_run_fcnc_files_total/2016/Zct/Central/bkg_WWTo2L2Nu.root",  //ww2l2n
    "../Result_run_fcnc_files_total/2016/Zct/Central/bkg_WZTo2L2Q.root",   //wz2l2q
    "../Result_run_fcnc_files_total/2016/Zct/Central/bkg_WZTo3LNu.root",   //wz3ln
    "../Result_run_fcnc_files_total/2016/Zct/Central/bkg_ZZTo2L2Nu.root",  //zz2l2n
    "../Result_run_fcnc_files_total/2016/Zct/Central/bkg_ZZTo2L2Q.root",   //zz2l2q
    "../Result_run_fcnc_files_total/2016/Zct/Central/bkg_ZZTo4L.root",     //zz4l
    "../Result_run_fcnc_files_total/2016/Zct/Central/bkg_sT_s.root",       //t_s
    "../Result_run_fcnc_files_total/2016/Zct/Central/bkg_sT_t_top.root",       //t_t
    "../Result_run_fcnc_files_total/2016/Zct/Central/bkg_sT_tW_top_TuneCUETP8M1.root",      //t_tw
    "../Result_run_fcnc_files_total/2016/Zct/Central/bkg_sT_t_antitop.root",   //tb_t
    "../Result_run_fcnc_files_total/2016/Zct/Central/bkg_sT_tW_antitop_TuneCUETP8M1.root",  //tb_tw
    "../Result_run_fcnc_files_total/2016/Zct/Central/bkg_tZq.root",
    "../Result_run_fcnc_files_total/2016/Zct/Central/bkg_DYJets_10to50.root",     //zjets(10-50)
    "../Result_run_fcnc_files_total/2016/Zct/Central/bkg_DYJets_50.root",         //zjets(50)

    "../Result_run_fcnc_files_total/2016/Zct/Central/data_double_e_combined.root" //data
};
...
double hist_scale[nFiles-1] = 
  {
    ...
    4.679           *INT_LUM/wz3ln,      //wz3ln    (X-sec modification : 4.42965->4.679)
    0.564           *INT_LUM/zz2l2n,    //zz2l2n
    3.22            *INT_LUM/zz2l2q,    //zz2l2q
    1.212           *INT_LUM/zz4l,        //zz4l
...
double BtagRatio(TH1* Evt_Before, TH1* Evt_After, string histname){
    ...
    double after;
    double Ratio;
    if(histname=="hist_w_mt_eem"){
        before = Evt_Before->GetBinContent(19);
        after  = Evt_After->GetBinContent(19);
    }
    if(histname=="hist_w_mt_eee"){
        before = Evt_Before->GetBinContent(18);
        after  = Evt_After->GetBinContent(18);
    }
    if(histname=="hist_Zmass_eem"){
        before = Evt_Before->GetBinContent(23);
        after  = Evt_After->GetBinContent(23);
    }
    if(histname=="hist_Zmass_eee"){
        before = Evt_Before->GetBinContent(22);
        after  = Evt_After->GetBinContent(22);
    }
    if(histname=="hist_mva_eem"){
        before = Evt_Before->GetBinContent(27);
        after  = Evt_After->GetBinContent(27);
    }
    if(histname=="hist_mva_eee"){
        before = Evt_Before->GetBinContent(26);
        after  = Evt_After->GetBinContent(26);
    }
    if(histname=="hist_b_no_eem" || histname=="hist_b_no_eee"){
        before=1.0;
        after=1.0;
    }
...
void plot_hist(TCanvas *c1, vector<TH1*> &hists, vector<TH1*> &Evt_Before, vector<TH1*> &Evt_After, //vector<TH1*> &hdata,
  ...
  TFile *myFILE = new TFile(("../research_progress/roofit/CR/sample/2016_Zct/Central/"+filename+".root").c_str(), "RECREATE");
  ...
  for(int i = nfiles-2; i >= 0; i--){
    ...
    //else if(plots[i]->GetNbinsX() > 10 && plots[i]->GetNbinsX() == 60) plots[i]->Rebin(5);
    //else if(plots[i]->GetNbinsX() > 10 && plots[i]->GetXaxis()->GetXmax()==150) plots[i]->Rebin(2);

    if( (histname!="hist_b_no_eem") && histname!="hist_b_no_eee" ) plots[i] = ReFill(AutoRebin((TH1D*)plots[i]), (TH1D*)plots[i]);
    //for(int j=12 ; j<plots[i]->GetNbinsX() ; j++){
    //    plots[i]->SetBinContent(j+1, 0.0);
    //}
 ...
 for(int ib=1; ib <= bkgHist->GetNbinsX()+1; ib++){
  ...
  //else if(plots[nfiles-1]->GetNbinsX() > 10 && plots[nfiles-1]->GetNbinsX() == 60) plots[nfiles-1]->Rebin(5);
  //else if(plots[nfiles-1]->GetNbinsX() > 10 && plots[nfiles-1]->GetXaxis()->GetXmax()==150) plots[nfiles-1]->Rebin(2);
  ...
  //for(int k=12 ; k<plots[nfiles-1]->GetNbinsX() ; k++){
  //    plots[nfiles-1]->SetBinContent(k+1, 0.0);
  //}
  ...
  for(int i = 1; i < nfiles; i++){
    //if(i ==1 || i==2 || i==4 || i==8 || i==14 || i==19 || i==20)
...
//{{{---------------------------------GetHist------------------------------------------
   ...
   hist = (TH1*) gDirectory->Get("hist_mva_eee");
   Final_mva_eee.push_back(hist);
   hist = (TH1*) gDirectory->Get("hist_mva_eem");
   Final_mva_eem.push_back(hist);

   hist = (TH1*) gDirectory->Get("hist_w_mt_eee");
   Final_w_mt_eee.push_back(hist);
   hist = (TH1*) gDirectory->Get("hist_w_mt_eem");
   Final_w_mt_eem.push_back(hist);

   hist = (TH1*) gDirectory->Get("hist_Zmass_eee");
   Final_Zmass_eee.push_back(hist);
   hist = (TH1*) gDirectory->Get("hist_Zmass_eem");
   Final_Zmass_eem.push_back(hist);
   
   hist = (TH1*) gDirectory->Get("hist_b_no_eem");
   Final_b_no_eem.push_back(hist);
   hist = (TH1*) gDirectory->Get("hist_b_no_eee");
   Final_b_no_eee.push_back(hist);
...
//{{{--- -----------------Plot Histgram---------------------------------------
  ...
  plot_hist(c1, Final_mva_eee, Final_evt_weightB, Final_evt_weightA, "MVA Response", nFiles, "MVA Response");
  c1->SaveAs("../mkplot_perf_2016/CR/MVA_sideband_eee.png");
  c1->cd();
  c1->cd()->SetRightMargin(0.08);
  plot_hist(c1, Final_mva_eem, Final_evt_weightB, Final_evt_weightA, "MVA Response", nFiles, "MVA Response");
  c1->SaveAs("../mkplot_perf_2016/CR/MVA_sideband_eem.png");
  c1->cd();
  c1->cd()->SetRightMargin(0.08);

  plot_hist(c1, Final_w_mt_eee, Final_evt_weightB, Final_evt_weightA, "Transverse Mass of W", nFiles, "Transverse Mass of W[GeV/c^{2}]");
  c1->SaveAs("../mkplot_perf_2016/CR/w_mt_eee.png");
  c1->cd();
  c1->cd()->SetRightMargin(0.08);
  plot_hist(c1, Final_w_mt_eem, Final_evt_weightB, Final_evt_weightA, "Transverse Mass of W", nFiles, "Transverse Mass of W[GeV/c^{2}]");
  c1->SaveAs("../mkplot_perf_2016/CR/w_mt_eem.png");
  c1->cd();
  c1->cd()->SetRightMargin(0.08);

  plot_hist(c1, Final_Zmass_eee, Final_evt_weightB, Final_evt_weightA, "Invariant Mass of Z", nFiles, "Invariant Mass of Z[GeV/c^{2}]");
  c1->SaveAs("../mkplot_perf_2016/CR/Zmass_eee.png");
  c1->cd();
  c1->cd()->SetRightMargin(0.08);
  plot_hist(c1, Final_Zmass_eem, Final_evt_weightB, Final_evt_weightA, "Invariant Mass of Z", nFiles, "Invariant Mass of Z[GeV/c^{2}]");
  c1->SaveAs("../mkplot_perf_2016/CR/Zmass_eem.png");
  c1->cd();
  c1->cd()->SetRightMargin(0.08);
  
  plot_hist(c1, Final_b_no_eem, Final_evt_weightB, Final_evt_weightA, "Transfer Ratio", nFiles, "Transfer Ratio");
  plot_hist(c1, Final_b_no_eee, Final_evt_weightB, Final_evt_weightA, "Transfer Ratio", nFiles, "Transfer Ratio");
