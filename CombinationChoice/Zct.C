...
void myTMVAClass( TString myMethodList = "" )
{
   ...
   TString fname = "./sigTT_kappa_zct_combined.root";
   ...
   TTree *signalT     = (TTree*)input->Get("mvaTree;1");
   TTree *backgroundT = (TTree*)input->Get("mvaTree;1");
   ...
   dataloader->AddBackgroundTree( backgroundT, backgroundWeight );
   ...
   TCut mycutb = "TopInfo_MCTruth==0"; // for example: TCut mycutb = "abs(var1)<0.5";
   ...
   if (Use["BDTG"]) // Gradient Boost
      factory->BookMethod(dataloader, TMVA::Types::kBDT, "BDTG",
                           "!H:!V:NTrees=400:MinNodeSize=2.5%:BoostType=Grad:Shrinkage=0.10:UseBaggedBoost:BaggedSampleFraction=0.5:nCuts=20:MaxDepth=3" );

   if (Use["BDT"])  // Adaptive Boost
      factory->BookMethod(dataloader, TMVA::Types::kBDT, "BDT",
                           "!H:!V:NTrees=400:MinNodeSize=2.5%:MaxDepth=3:BoostType=AdaBoost:AdaBoostBeta=0.5:UseBaggedBoost:BaggedSampleFraction=0.5:SeparationType=GiniIndex:nCuts=20:CreateMVAPdfs" );
